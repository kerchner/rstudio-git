...
Let's take the blank slate scenario.  First we create a new project:
...
Also note that there's now a Git tab in the upper right pane, next to "Environment" and "History".

Next, we select "New Directory":

![](../fig/RStudio_screenshot_newdirectory.png)
